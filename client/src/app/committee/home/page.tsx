        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex-grow w-full lg:w-3/4">
            <ApplicationTimerBanner
              ...
              overrideTitle="Committee Voting Panel"
            />
          </div>
          ...
          <div className="w-full lg:w-1/4 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col h-[300px]">
            ...
            <div className="flex-grow space-y-4 overflow-y-auto pr-2">
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <p className="text-xs font-bold text-gray-800">ส่งใบสมัครแล้ว</p>
                  <p className="text-[10px] text-gray-500 leading-tight mt-0.5">
                    มีใบสมัครรอการโหวตจากคณะกรรมการ
                  </p>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <p className="text-xs font-bold text-gray-800">รอดำเนินการ</p>
                  <p className="text-[10px] text-gray-500 leading-tight mt-0.5">
                    ยังมีใบสมัครที่คุณยังไม่ได้โหวต
                  </p>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              <Link href="/committee/applications" className="text-xs font-bold text-green-700 hover:text-green-800">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {awardTypes.map((type, index) => {
              ...
              const gradientType =
                index % 3 === 0 ? 'purple' : index % 3 === 1 ? 'blue' : 'yellow';
