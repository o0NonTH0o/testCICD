...
export default function ViceDeanHomePage() {
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="w-full lg:w-1/4 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col h-[300px]">
                ...
                <div className="flex-grow space-y-4 overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div className="flex gap-3 items-start">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-gray-500 leading-tight mt-0.5">You have applications pending your approval.</p>
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                    <Link href="/vice-dean/notifications" className="text-xs font-bold text-green-700 hover:text-green-800">
