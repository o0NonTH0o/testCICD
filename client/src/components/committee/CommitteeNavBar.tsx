...
export default function CommitteeNavBar() {
  ...
  const isHomeActive = pathname?.startsWith('/committee/home') || pathname === '/committee';
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Committee Portal</p>
          </div>
        </div>
      </div>

      <div className="hidden md:flex items-center space-x-8">
        <Link href="/committee/home" className={getLinkClasses(isHomeActive)}>
          Home
        </Link>
      </div>
        ...
        {loading ? (
          ...
          <>
            <div className="text-right hidden sm:block">
              ...
              <p className="text-xs text-gray-500 uppercase">COMMITTEE</p>
            </div>
